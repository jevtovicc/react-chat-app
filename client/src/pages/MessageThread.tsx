...
// TODO: fix height problem with h-5/6
function MessageThread() {
    ...
    return (
        <main className='bg-gray-900 text-gray-100 py-4 px-8 h-screen flex flex-col justify-between'>
            ...
            <form className="flex">
                <input type="text" className="w-full bg-transparent text-gray-300 border border-gray-700 border-r-0 rounded-tl-lg rounded-bl-lg py-3 px-2 outline-none focus:border-blue-700" />
