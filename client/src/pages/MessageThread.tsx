    ...
    return (
        <main className='bg-gray-900 text-gray-100 py-4 px-8 h-screen flex flex-col justify-between'>
            ...
            <form className="flex py-4" onSubmit={handleSubmit}>
                ...
                <button disabled={inputValue.trim().length === 0} type="submit" className="bg-blue-700 border border-blue-700 py-3 px-2 rounded-tr-lg rounded-br-lg disabled:cursor-not-allowed disabled:opacity-50">
